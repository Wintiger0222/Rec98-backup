...
loc_177AF:
		...
		mov	[bp+var_E], al
		mov	al, byte_23E3C
		add	byte ptr word_23E42, al
		cmp	byte ptr word_23E42, 80h
		jbe	short loc_177CA
		mov	byte ptr word_23E42, 80h
		jmp	short loc_177D6
; ---------------------------------------------------------------------------

loc_177CA:
		cmp	byte ptr word_23E42, 10h
		jnb	short loc_177D6
		mov	byte ptr word_23E42, 10h
