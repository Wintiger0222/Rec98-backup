...
loc_AEF0:
		call	popup_number_update
		call	circles_update
		call	sparks_update
		call	u_player_update
		call	u_player_render
		call	lasers_update
		call	u_enemy_bullet_update
		call	u_enemy_update
		call	_midboss_update
		call	_boss_update
		call	items_update
		call	u_gather_effect_update
		call	_stage_render
		cmp	byte_2429A, 0
		jz	short loc_AF2D
		call	fp_2429C
...
loc_AF88:
		...
		cmp	_debug_option, 0
		jnz	short loc_AFB5
		mov	_debug_option, 0FEh
		jmp	short loc_AFDF
; ---------------------------------------------------------------------------

loc_AFB5:
		cmp	_debug_option, 0FFh
		jnz	short loc_AFDF
		mov	_debug_option, 1
		jmp	short loc_AFDF
; ---------------------------------------------------------------------------
...
loc_AFD1:
		cmp	_debug_option, 0FEh
		jnz	short loc_AFDF
		mov	_debug_option, 0FFh
		jmp	short $+2
...
loc_B48A:
		nopcall	hud_power_update_and_render
		push	ds
...
include th04/popupnum/count_reset.asm
include th04/popupnum/invalidate.asm
include th04/popupnum/update.asm
		nop
include th05/popupnum/render.asm
		nop
include th04/popupnum/numerals_draw.asm
...
hud_power_update_and_render	proc far
		xor	bx, bx
		xor	ax, ax
		mov	al, power
		mov	cx, 9
...
loc_E511:
		...
		retf
hud_power_update_and_render	endp
...
sub_E5EE	proc near
		push	si
		push	di
		mov	si, offset u_enemy_bullet_dot_struct
		mov	di, 0B4h
...
loc_E666:
		...
		dec	di
		jnz	short loc_E641
		mov	si, offset u_gather_effect_struct
		mov	di, 10h
...
sub_EACE	proc near
		...
		push	size _shots / 4
		call	sub_E708
		push	offset u_enemy_struct
		push	200h
		call	sub_E708
		push	offset _sparks
		push	size _sparks / 4
		call	sub_E708
		push	offset u_enemy_bullet_struct
		push	3200h / 4
		call	sub_E708
		push	0B290h
		push	1A0h
		...
		push	size _items / 4
		call	sub_E708
		push	offset _popup_number
		push	size _popup_number / 4
		call	sub_E708
		push	offset u_gather_effect_struct
		push	98h
		call	sub_E708
		mov	word_2A72C, 8
		mov	byte_2A72E, 9
...
dialog_frame_fade_in	proc near
		push	bp
		mov	bp, sp
		push	si
		mov	vsync_Count1, 0
...
loc_EFBA:
		call	dialog_frame_draw pascal, (48 shl 16) or 192, si
		call	dialog_frame_draw pascal, (80 shl 16) or 320, si
...
dialog_init	proc far
		push	bp
		mov	bp, sp
;yes, this is dialog_init
;to skip dialog at extra demo play, zun put this code at here
		les	bx, _resident
		cmp	es:[bx+resident_t.demo_num], 0
		jz	short loc_F333
		cmp	byte_221EC, 0
...
loc_F333:
		...
		call	far ptr	palette_show
		graph_accesspage _page_front
		call	dialog_frame_fade_in
		call	dialog_frame_render
		call	sub_F1A6
		call	player_cdg_load
...
var_2		= word ptr -2
		...
		mov	ax, GRAM_400
		mov	es, ax
		mov	si, offset u_enemy_bullet_imaged_struct_top
		mov	[bp+var_2], 0
		jmp	loc_10171
; ---------------------------------------------------------------------------
...
loc_10461:
		call	text_putsa pascal, (62 shl 16) + 13, ds, offset alive_times, TX_WHITE
		cmp	[bp+var_1], 0Ah
		jl	short loc_104A2
		push	(68 shl 16) + 13
		mov	al, [bp+var_1]
...
loc_10514:
		mov	al, bombs
		mov	[bp+var_1], al
		call	text_putsa pascal, (62 shl 16) + 11, ds, offset abomb_times, TX_WHITE
		cmp	[bp+var_1], 0Ah
		jl	short loc_1055B
		push	(68 shl 16) + 11
		mov	al, [bp+var_1]
...
@@bar_color		= word ptr -0Ah
		...
		mov	bp, sp
		sub	sp, 0Ah
		mov	ax, word ptr HUD_DREAM_BAR_COLORS+0
		mov	word ptr [bp+@@bar_color+0], ax
		mov	ax, word ptr HUD_DREAM_BAR_COLORS+2
		mov	word ptr [bp+@@bar_color+2], ax
		mov	ax, word ptr HUD_DREAM_BAR_COLORS+4
		mov	word ptr [bp+@@bar_color+4], ax
		mov	ax, word ptr HUD_DREAM_BAR_COLORS+6
		mov	word ptr [bp+@@bar_color+6], ax
		mov	al, byte ptr HUD_DREAM_BAR_COLORS+8
...
var_A		= byte ptr -0Ah
		...
		push	si
		push	di
		mov	si, offset HUD_POWER_BAR_COLORS
		lea	di, [bp+var_A]
		push	ss
		pop	es
		mov	cx, 5
...
; Attributes: bp-based frame
public HUD_BOSS_HP_DRAW
hud_boss_hp_draw	proc far
...
@@boss_hp		= word ptr  6
		...
		mov	ax, word ptr HUD_BOSS_HP_BAR_COLORS
		mov	word ptr [bp+@@bar_color+0], ax
		mov	ax, word ptr HUD_BOSS_HP_BAR_COLORS+2
		mov	word ptr [bp+@@bar_color+2], ax
		mov	al, byte ptr HUD_BOSS_HP_BAR_COLORS+4
		mov	byte ptr [bp+@@bar_color+4], al
		or	si, si
		jz	short @@remove_boss_hp
...
loc_1082D:
		push	ax
		call	gaiji_putsa
		call	hud_boss_hp_draw pascal, 0
		pop	bp
		retf
...
u_enemy_move_and_test_leave	proc near
		lea	ax, [si+2]
...
loc_15319:
		...
		stc
		retn
u_enemy_move_and_test_leave	endp
...
loc_153A1:
		call	u_enemy_move_and_test_leave
		jb	short enemy_script_0
		mov	ah, es:[di+3]
		mov	al, 4
		jmp	loc_15748
; ---------------------------------------------------------------------------
...
loc_1575C:
		...
		pop	si
		retn
u_step_enemy_script	endp

; ---------------------------------------------------------------------------
off_1575F	dw offset enemy_script_0
		dw offset enemy_script_1
		dw offset enemy_script_2
		dw offset enemy_script_3
		dw offset enemy_script_4
		dw offset enemy_script_5
		dw offset enemy_script_6
		dw offset enemy_script_7
		dw offset enemy_script_8
		dw offset enemy_script_9
		dw offset enemy_script_10
		dw offset enemy_script_11
		dw offset enemy_script_12
		dw offset enemy_script_13
		dw offset enemy_script_14
		dw offset enemy_script_15
		dw offset enemy_script_16
		dw offset enemy_script_17
		dw offset enemy_script_18
		dw offset enemy_script_19
		dw offset enemy_script_20
		dw offset enemy_script_21
		dw offset enemy_script_22_31
		dw offset enemy_script_23
		dw offset enemy_script_24
		dw offset enemy_script_25
		dw offset enemy_script_26
		dw offset enemy_script_27
		dw offset enemy_script_28
		dw offset enemy_script_29
		dw offset enemy_script_30
		dw offset enemy_script_22_31
		dw offset enemy_script_32
		dw offset enemy_script_33
		dw offset enemy_script_34
		dw offset enemy_script_35
		dw offset enemy_script_36
		dw offset enemy_script_37
		dw offset enemy_script_38
		dw offset enemy_script_39
		dw offset enemy_script_40
		dw offset enemy_script_41
		dw offset enemy_script_42
		dw offset enemy_script_43
		dw offset enemy_script_44
		dw offset enemy_script_45
		dw offset enemy_script_46
		dw offset enemy_script_47
		dw offset enemy_script_48
		dw offset enemy_script_49
		dw offset enemy_script_50_51
		dw offset enemy_script_50_51
		dw offset enemy_script_52
		dw offset enemy_script_53
		dw offset enemy_script_54
		dw offset enemy_script_55
		dw offset enemy_script_56
		dw offset loc_15516
		dw offset loc_15616
; ---------------------------------------------------------------------------
		nop
...
include th04/popupnum/add_num.asm
		nop
...
loc_15CE5:
		...
		jnz	short loc_15CFD
		mov	si, offset u_enemy_bullet_dot_struct_top
		mov	di, 180
		jmp	short loc_15D03
; ---------------------------------------------------------------------------
...
u_gather_effect_update	proc far
		push	bp
		mov	bp, sp
		push	si
		push	di
...
loc_16F9B:
		inc	power
		call	hud_power_update_and_render
		mov	si, 1
		jmp	loc_17174
; ---------------------------------------------------------------------------
...
loc_17174:
		...
		push	word ptr [di+4]
		push	si
		call	popup_number_add_number_white
		jmp	short loc_17199
; ---------------------------------------------------------------------------
...
loc_1718F:
		...
		push	word ptr [di+4]
		push	si
		call	popup_number_add_number_yellow
...
; Attributes: bp-based frame
public HUD_BOSS_HP_PUT
hud_boss_hp_put	proc near

@@boss_cur_hp		= word ptr  4
@@boss_max_hp		= word ptr  6

		push	bp
		mov	bp, sp
		push	si
		push	di
		mov	di, [bp+@@boss_max_hp]
		or	di, di
		jg	short loc_17364
		xor	si, si
		jmp	short loc_17389
...
loc_17389:
		cmp	hud_boss_hp_percent, si
		jge	short loc_17393
		inc	hud_boss_hp_percent ; for effect for boss hp bar increase at start

loc_17393:
		cmp	hud_boss_hp_percent, si
		jle	short loc_1739D
		mov	hud_boss_hp_percent, si

loc_1739D:
		push	hud_boss_hp_percent
		call	hud_boss_hp_draw
		pop	di
		pop	si
		pop	bp
		retn	4
...
u_enemy_bullet_update	proc far
...
; ---------------------------------------------------------------------------
		db 0
include th04/popupnum/convert_num.asm
		nop
...
off_221D0	dd a_dm00_tx2
					; "_DM00.TX2"
dialog_frame_tile label word
		dw  8888h, 4444h, 2222h, 1111h
		dw 0CCCCh, 6666h, 3333h, 9999h
		dw 0EEEEh, 7777h,0BBBBh,0DDDDh
byte_221EC	db 0
...
include th04/popupnum/popupnum_index[bss].asm
byte_2429A	db ?
byte_2429B	db ?
fp_2429C	dw ?
...
label u_enemy_bullet_struct byte
public u_enemy_bullet_dot_struct, u_enemy_bullet_dot_struct_top
u_enemy_bullet_dot_struct			db 32*179 dup (?)
u_enemy_bullet_dot_struct_top		db 32 dup (?)
public u_enemy_bullet_imaged_struct, u_enemy_bullet_imaged_struct_top
u_enemy_bullet_imaged_struct 		db 32*219 dup (?)
u_enemy_bullet_imaged_struct_top	db 32 dup (?)	
		db    ?	;
		dd    ?	;
		dd    ?	;
		dd    ?	;
		...
		db    ?	;
		db    ?	;
public u_enemy_struct 
u_enemy_struct 	db 64*32 dup (?)		
public u_gather_effect_struct 
u_gather_effect_struct 	dd 152 dup (?)	
		dd    ?	;
		dd    ?	;
		dd    ?	;
		dd    ?	;
...
include th04/popupnum/popupnum[bss].asm
