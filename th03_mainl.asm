...
loc_96B7:
		...
		call	file_seek
		push	ds
		push	offset story_buffer_1
		push	60
		call	file_read
		mov	story_buffer_1+60, 0
		push	ds
		push	offset story_buffer_2
		push	60
		call	file_read
		mov	story_buffer_2+60, 0
		push	ds
		push	offset story_buffer_3
		push	60
		call	file_read
		mov	story_buffer_3+60, 0
		call	file_close
		leave
		retn
sub_9624	endp
...
sub_973E	proc near
		push	bp
		mov	bp, sp
		call	graph_putsa_fx pascal, (80 shl 16) or 272, 2Fh, ds, offset story_buffer_1
		call	graph_putsa_fx pascal, (80 shl 16) or 288, 2Fh, ds, offset story_buffer_2
		call	graph_putsa_fx pascal, (80 shl 16) or 304, 2Fh, ds, offset story_buffer_3
		pop	bp
		retn
sub_973E	endp
...
CHAR_IMAGE	dw offset a00sl_cd2
		dw offset a02sl_cd2
		dw offset a04sl_cd2
		dw offset a06sl_cd2
		dw offset a08sl_cd2
		...
		dw offset a14sl_cd2
		dw offset a16sl_cd2
CHAR_TXT	dd a@00tx_txt		; "@00TX.TXT"
...
include th03/snd/snd_active[data].asm
...
aSCORE_PLAYCHARS label dword
		...
		db  0Eh
		db  0Eh
off_ED66	dw offset aYume_nem
off_ED68	dw offset aRft0_cdg
unk_ED6A	db    0
		db    0
		db    0
		db    0
...
story_buffer_1	db 61 dup (?)
story_buffer_2	db 61 dup (?)
story_buffer_3	db 61 dup (?)
byte_F7E3	db ?
byte_F7E4	db ?
byte_F7E5	db ?
