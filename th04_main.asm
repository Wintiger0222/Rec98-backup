...
loc_ABD8:
		call	main_01:popup_number_update
		...
		call	main_01:popup_number_render
...
sub_B1D0	proc near
		...
		nopcall	main_01:hud_power_update_and_render
		...
		call	hud_score_put
		call	sub_15D74
		call	main_01:popup_number_count_reset
		nopcall	main_01:hud_put
...
include th04/popupnum/render.asm
...
sub_CB58	proc near
		...
		call	main_01:popup_number_invalidate
...
dm_txt_init_stage5_bad_end	proc far
		push	bp
		mov	bp, sp
		les	bx, _resident
		mov	al, es:[bx+resident_t.playchar_ascii]
		...
		pop	bp
		retf
dm_txt_init_stage5_bad_end	endp
...
loc_D0A6:
		call	main_01:dialog_frame_draw pascal, (48 shl 16) or 192, si
		call	main_01:dialog_frame_draw pascal, (80 shl 16) or 320, si
...
dialog_init	proc far
		...
		call	far ptr	palette_show
		graph_accesspage _page_front
		call	main_01:dialog_frame_fade_in
		call	main_01:dialog_frame_render
		call	main_01:sub_D56C
		push	2
		nopcall	main_01:sub_CBA4
		call	main_01:player_cdg_load
...
hud_graze_put	proc far
		push	bp
		mov	bp, sp
		call	hud_int_put  pascal, (62 shl 16) + 19, _stage_graze
		pop	bp
		retf
hud_graze_put	endp
...
loc_F24F:
		push	TX_YELLOW
		call	gaiji_putsa
		call	main_01:hud_bombs_put
		call	main_01:hud_lives_put
		les	bx, _resident
		cmp	es:[bx+resident_t.playchar_ascii], '0' + PLAYCHAR_REIMU
		jnz	short loc_F276
		push	(57 shl 16) + 13
...
arg_0		= word ptr  4
		...
		movzx	eax, ax
		add	_score_delta, eax
		mov	_popup_number_double_times, 0
		mov	ax, _midboss_pos.cur.x
		add	ax, (-64 shl 4)
		mov	[bp+var_2], ax
		mov	ax, _midboss_pos.cur.y
...
loc_1DC19:
		...
		cmp	_popup_number_double_times, 0
		jz	loc_1DD93
		inc	byte_23660
		jmp	loc_1DD93
; ---------------------------------------------------------------------------
...
@@angle		= byte ptr -1
		...
		cmp	byte_236E0, 0
		jz	short loc_1DE74
		mov	_popup_number_double_times, 1
		jmp	short loc_1DE79
; ---------------------------------------------------------------------------
...
loc_1E7F2:
		call	dm_txt_init_stage5_bad_end
		call	dialog_init
		call	end_game_bad
...
loc_201B4:
		call	randring2_next16_and	; jumptable 0001F539 case 36296
		mov	byte_266E2, al
		push	(64 shl 4)
		call	randring2_next16_mod
		mov	dx, _boss_pos.cur.x
...
aSt00_map	db 'ST00.MAP',0
		db 0
_popup_number_double_times	db 0
		db 0
; 0
...
STAGE_TITLE		dd aMCB@bPhantomLa	; "Œ¶–ì@` Phantom Land "
		...
		dd aVVVcvVvmnvRViv	; "‚·‚Î‚ç‚µ‚¢ŒN‚ÉÃ‚©‚È÷‚è‚ð@` Puckish "...
