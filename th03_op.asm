...
loc_B932:
		test	di, 1
		jz	short loc_B951
		dec	byte ptr byte_FC58[si]
		cmp	byte ptr byte_FC58[si], 0
		jge	short loc_B94C
		mov	al, byte_FC68
		dec	al
		mov	byte_FC58[si], al
...
aTl02_pi	db 'TL02.PI',0
		db 0
off_E1F2	dw offset aYume_nem
aYume_nem	db 'YUME.NEM',0
		db 0
off_E1FE	dd a00sl_cd2	; "00SL.CD2"
...
struct_FB84	dw ?
		...
		dd    ?	;
		dd    ?	;
public byte_FBD6, byte_FBD7, byte_FBDC
byte_FBD6	db ?
byte_FBD7	db ?
		dd    ?	;
byte_FBDC	db ?
		...
		db    ?	;
		db    ?	;
public byte_FC50, byte_FC51, word_FC52, byte_FC58, byte_FC59, byte_FC5A, byte_FC5B, byte_FC5C, word_FC62, word_FC64, word_FC66, byte_FC68
byte_FC50	db ?
byte_FC51	db ?
