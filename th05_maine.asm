...
; int __stdcall	game_exit_to_binary(char *arg0)
game_exit_to_binary	proc near
...
loc_A5DC:
		...
		les	bx, ed_name
		mov	es:[bx+4], al
		push	word ptr ed_name+2
		push	bx
		call	ed_txt_load
		call	ending_update_and_render
		pop	bp
		retn
ending_cutsceen	endp
...
loc_A6AD:
		call	file_size
		mov	[bp+var_2], ax
		mov	ending_script_index, offset ending_script_buffer
		push	ds
		push	ending_script_index
		push	ax
		call	file_read
		call	file_close
		xor	ax, ax
...
@@digit_1 = byte ptr [bp-2]
@@digit_2 = byte ptr [bp-1]
@@digit_3 equ cl
arg_0 = dword ptr  4

		enter	2, 0
		mov	bx, ending_script_index
		mov	@@digit_3, [bx]
		inc	ending_script_index
		mov	bx, ending_script_index
		mov	al, [bx]
		mov	@@digit_2, al
		inc	ending_script_index
		...
		mov	ah, 0
		mov	bx, ax
		test	byte ptr __ctype+1[bx], 2
		jnz	short loc_A77F
		les	bx, [bp+arg_0]
		mov	ax, read_number_def_value
		mov	es:[bx], ax
		sub	ending_script_index, 3
		leave
		retn	4
; ---------------------------------------------------------------------------
...
ending_text_go_out_screen	proc near
		push	bp
		mov	bp, sp
		add	ending_text_cursor.x, 16
		cmp	ending_text_cursor.x, 560
		jl	short @@ok
		add	ending_text_cursor.y, 16
		mov	ending_text_cursor.x, 144
		cmp	ending_text_cursor.y, 384
		jl	short @@ok
		call	sub_A8EC
		cmp	byte_14F8E, 0
		jnz	short loc_A858
		call	sub_A92B pascal, 0

loc_A858:
		mov	ending_text_cursor.x, 80
		mov	ending_text_cursor.y, 320

@@ok:
		pop	bp
		retn
ending_text_go_out_screen	endp
...
loc_A904:
		push	si
		call	sub_A866
		call	frame_delay pascal, ending_text_typing_delay
		inc	si
...
loc_A962:
		call	_input_reset_sense_held
		call	bgimage_put_rect pascal, 576, ending_text_cursor.y, (16 shl 16) or 16
		or	si, si
		jle	short loc_A9BD
...
ed_text_script_translate	proc near
...
text_s_option:
		mov	bx, ending_script_index	; jumptable 0000A9F2 case 115
		mov	al, [bx]
		mov	[bp+arg_0], al
		call	sub_A8EC
		cmp	[bp+arg_0], '-'
		jz	short loc_AA3A
		mov	read_number_def_value, 0
		push	ss
		lea	ax, [bp+var_2]
		push	ax
		call	read_number
...
text_c_color:
		mov	bx, ending_script_index	; jumptable 0000A9F2 case 99
		mov	al, [bx]
		mov	ah, 0
		push	ax		; ch
		call	_tolower
		...
		cmp	[bp+arg_0], '='
		jz	loc_AF34
		mov	read_number_def_value, 15
		push	ss
		lea	ax, [bp+var_2]
		push	ax
		call	read_number
		mov	al, byte ptr [bp+var_2]
		mov	ending_text_color, al
		jmp	text_option_none	; default
; ---------------------------------------------------------------------------

text_b_option:
		mov	read_number_def_value, 2	
		push	ss
		lea	ax, [bp+var_2]
		push	ax
		call	read_number
...
text_v_option:
		mov	bx, ending_script_index	; jumptable 0000A9F2 case 118
		cmp	byte ptr [bx], 'p'
		jz	short loc_AB91
		mov	read_number_def_value, 2
		push	ss
		...
		call	read_number
		mov	ax, [bp+var_2]
		mov	ending_text_typing_delay, ax
		jmp	text_option_none	; default
; ---------------------------------------------------------------------------
...
text_f_fade:
		...
		mov	[bp+arg_0], al
		cmp	[bp+arg_0], 'm'
		jz	short text_f_music_fade
		cmp	[bp+arg_0], 'i'
		jz	short text_f_screen_fade_in_out
		cmp	[bp+arg_0], 'o'
		jnz	text_option_none	; default

text_f_screen_fade_in_out:
		inc	ending_script_index
		mov	read_number_def_value, 1
		push	ss
		lea	ax, [bp+var_2]
		...
		call	read_number
		cmp	[bp+arg_0], 'i'
		jnz	short text_f_screen_fade_out

text_f_screen_fade_in:
		push	[bp+var_2]
		call	palette_black_in
		jmp	text_option_none	; default

text_f_screen_fade_out:
		push	[bp+var_2]
...
text_g_option:
		mov	read_number_def_value, 8	; jumptable 0000A9F2 case 103
		push	ss
		lea	ax, [bp+var_2]
		push	ax
		call	read_number
...
text_p_option:
		mov	bx, ending_script_index	; jumptable 0000A9F2 case 112
		mov	al, [bx]
		mov	[bp+arg_0], al
		inc	ending_script_index
		cmp	[bp+arg_0], '='
...
loc_AD47:
		...
		mov	ah, 0
		mov	bx, ax
		test	byte ptr __ctype+1[bx], 20h
		jnz	short loc_AD7A
...
loc_AD9A:
		mov	read_number_def_value, 4	; jumptable 0000A9F2 case 61
		mov	bx, ending_script_index
		mov	al, [bx]
		mov	[bp+arg_0], al
...
text_m_music:
		mov	bx, ending_script_index	; jumptable 0000A9F2 case 109
		mov	al, [bx]
		mov	[bp+arg_0], al
		cmp	[bp+arg_0], '$'
		jnz	short @@not_pause
...
loc_AF11:
		...
		jmp	short text_option_none	; default
; ---------------------------------------------------------------------------
...
loc_AF34:
		inc	ending_script_index
		mov	al, ending_color_table_count
		mov	ah, 0
		imul	ax, 6
		mov	bx, ending_script_index
		mov	dl, [bx]
...
loc_AF91:
		...
		leave
		retn	2
ed_text_script_translate	endp

; ---------------------------------------------------------------------------
word_AF96	dw '$', '=', '@', 'b'
		dw 'c', 'e', 'f', 'g' ; value table for switch	statement
		dw 'k', 'm', 'n', 'p'
		dw 's', 't', 'v', 'w'
		dw offset loc_AF8B	; jump table for switch	statement
		dw offset loc_AD9A
		dw offset loc_ACAA
		dw offset text_b_option
		dw offset text_c_color
		dw offset text_e_option
		dw offset text_f_fade
		dw offset text_g_option
		dw offset text_k_option
		dw offset text_m_music
		dw offset text_n_line_change
		dw offset text_p_option
		dw offset text_s_option
		dw offset text_t_option
		dw offset text_v_option
		dw offset text_w_screen_white

; =============== S U B	R O U T	I N E =======================================

; Attributes: bp-based frame

ending_update_and_render	proc near
...
@@ch		= word ptr -2
		...
		mov	word ptr [bp+@@str], offset ending_text_wchar_buffer
		mov	ending_text_cursor.x, 80
		mov	ending_text_cursor.y, 320
		mov	ending_text_typing_delay, 2
		mov	ending_text_color, 15
...
loc_B01D:
		...
		jz	short loc_B005
		cmp	byte ptr [bp+@@ank], '\'
		jnz	short @@not_control_char
		mov	bx, ending_script_index
		mov	al, [bx]
		mov	byte ptr [bp+@@ank], al
		inc	ending_script_index
		push	[bp+@@ank]
		call	ed_text_script_translate
		cmp	al, -1
		jnz	short loc_B005
		jmp	loc_B196
; ---------------------------------------------------------------------------
...
loc_B0AE:
		mov	bx, ending_script_index	; jumptable 0000B095 case 33
		mov	al, [bx]
		mov	byte ptr [bp+@@ank], al
		inc	ending_script_index
		mov	ah, 0
...
loc_B0E2:
		dec	ending_script_index	; default
		mov	read_number_def_value, 3
		push	ss
		lea	ax, [bp+@@ch]
		push	ax
		call	read_number
...
loc_B0F4:
		graph_showpage 0
		graph_accesspage 1
		push	ending_text_cursor.x
		push	ending_text_cursor.y
		push	[bp+@@ch]
		mov	al, ending_text_color
		mov	ah, 0
		push	ax
		call	graph_gaiji_putc
		jmp	short loc_B18D
...
loc_B18D:
		call	ending_text_go_out_screen
		mov	si, 1
		jmp	loc_B005
; ---------------------------------------------------------------------------
...
arg_2		= word ptr  6
		...
		add	ax, dx
		mov	bx, ax
		mov	ax, word ptr ALLCAST_SCENE_SLOT[bx]
		mov	[bp+var_2], ax
		push	2
		call	palette_black_out
...
loc_B309:
		...
		add	ax, dx
		mov	bx, ax
		pushd	dword ptr ALLCAST_SCENE[bx]
		call	pi_slot_load
...
ed_name	dd a_ed00_txt; "_ED00.TXT"
...
ending_color_table_count	db 0
		...
		db 0FFh
		db 0FFh
public ending_text_wchar_buffer
ending_text_wchar_buffer	db '  ', 0
	even
byte_1085E	db 0
		db 0
ALLCAST_SCENE		dd aExed01_pi		; "EXED01.pi"
		...
		dd 0
ALLCAST_SCENE_SLOT	dw    1,0,1,3,0,0,0,0
		dw    1,0,1,2,1,1,1,0
		dw	  1,2,0,1,0,2,2,0
		dw    1,0,0,2,0,3,3,0
...
;clip[bss].asm always over ther fil[bss].asm, so I think this position is right -windowstiger
public _resident
_resident	dd ?
...
public ending_script_buffer
ending_script_buffer		db    ?	;
		db    ?	;
		db    ?	;
		db    ?	;
		dd    ?	;
...
byte_14F8E	db ?
		...
		dd    ?	;
		db    ?	;
public ending_text_cursor
ending_text_cursor	Point <?>
ending_text_typing_delay	dw ?
ending_text_color	db ?
		db ?
read_number_def_value	dw ?
measure_1500E	dw ?
word_15010	dw ?
word_15012	dw ?
