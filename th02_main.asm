...
loc_B4D7:
		...
		push	ds
		push	offset palette_1F4AD ; dest
		call	_memcpy
		add	sp, 0Ah
		call	sub_1C608
		call	sub_1C3DF
...
var_2		= word ptr -2
		...
		mov	ax, word ptr HUD_POWER_BAR_COLORS
		mov	word ptr [bp+var_12], ax
		mov	ax, word ptr HUD_POWER_BAR_COLORS+2
		mov	word ptr [bp+var_12+2], ax
		mov	ax, word ptr HUD_POWER_BAR_COLORS+4
		mov	word ptr [bp+var_12+4], ax
		mov	ax, word ptr HUD_POWER_BAR_COLORS+6
		mov	word ptr [bp+var_12+6], ax
		mov	al, byte ptr HUD_POWER_BAR_COLORS+8
